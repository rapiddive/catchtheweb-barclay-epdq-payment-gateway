...
class RapidDive_Epdq_ErrorCodes {
	...
	public static $errorCodes = [
		...
		50001036 => 'Card length does not correspond to an acceptable value for the brand.',
		50001068 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001069 => 'Invalid check for CardID and Brand.',
		50001070 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001116 => 'Unknown origin IP.',
		50001117 => 'No origin IP detected.',
		50001118 => 'Merchant configuration problem. Please contact support.',
		10001001 => self::COMMUNICATION_FAILURE,
		10001002 => self::COMMUNICATION_FAILURE,
		10001003 => self::COMMUNICATION_FAILURE,
		10001004 => self::COMMUNICATION_FAILURE,
		10001005 => self::COMMUNICATION_FAILURE,
		10001016 => 'Waiting for acquirer feedback.',
		10001018 => '3XCB pending transaction awaiting for Final status.',
		20001001 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		...
		20001003 => self::WE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_WILL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_STATUS_OF_THE_TRANSACTION_PLEASE_CHECK_THE_STATUS_LATER,
		20001004 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001005 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001006 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001007 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001008 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001009 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001010 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001101 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		20001104 => self::WE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_WILL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_STATUS_OF_THE_TRANSACTION_PLEASE_CHECK_THE_STATUS_LATER,
		20001105 => self::WE_HAVE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_SHALL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_TRANSACTION_STATUS_WITHIN_ONE_WORKING_DAY_PLEASE_CHECK_THE_STATUS_LATER,
		20001111 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		20001998 => self::WE_RECEIVED_AN_UNKNOWN_STATUS_FOR_THE_TRANSACTION_WE_WILL_CONTACT_YOUR_ACQUIRER_AND_UPDATE_THE_STATUS_OF_THE_TRANSACTION_PLEASE_CHECK_THE_STATUS_LATER,
		...
		30001001 => self::PAYMENT_REFUSED_BY_THE_FINANCIAL_INSTITUTION,
		30001002 => 'Duplicate request.',
		30001010 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		30001011 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		30001012 => 'Card blacklisted - Contact acquirer.',
		30001015 => self::THERE_HAS_BEEN_A_CONNECTION_ERROR_TO_THE_RECEIVING_BANK_PLEASE_TRY_LATER_OR_CHOOSE_ANOTHER_PAYMENT_METHOD,
		...
		30001051 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		30001054 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		30001056 => 'Your merchant\'s acquirer is temporarily unavailable, please try later or choose another payment method.',
		30001057 => self::THERE_HAS_BEEN_A_CONNECTION_ERROR_TO_THE_RECEIVING_BANK_PLEASE_TRY_LATER_OR_CHOOSE_ANOTHER_PAYMENT_METHOD,
		30001058 => self::THERE_HAS_BEEN_A_CONNECTION_ERROR_TO_THE_RECEIVING_BANK_PLEASE_TRY_LATER_OR_CHOOSE_ANOTHER_PAYMENT_METHOD,
		...
		30001154 => self::YOU_HAVE_REACHED_THE_PERMITTED_USAGE_LIMIT,
		30001155 => self::YOU_HAVE_REACHED_THE_PERMITTED_USAGE_LIMIT,
		30001156 => self::YOU_HAVE_REACHED_THE_PERMITTED_USAGE_LIMIT,
		...
		30001998 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		30001999 => 'There has been a connection error with the receiving bank. Please try later or choose another payment method.',
		30002001 => self::PAYMENT_REFUSED_BY_THE_FINANCIAL_INSTITUTION,
		30002001 => self::PAYMENT_REFUSED_BY_THE_FINANCIAL_INSTITUTION,
		...
		30201001 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		30301001 => 'Invalid format.',
		30311001 => 'Unknown acquirer ID.',
		30331001 => 'Card expired.',
		30341001 => self::SUSPICION_OF_FRAUD,
		30341001 => self::SUSPICION_OF_FRAUD,
		...
		30381001 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		...
		30591001 => self::SUSPICION_OF_FRAUD,
		...
		30971001 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		30981001 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		...
		32001004 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		32001105 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		...
		40001001 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001002 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001003 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001004 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001005 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001006 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001007 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001008 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001009 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001010 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		40001011 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		40001012 => 'There has been a connection error with the receiving bank. Please try later or choose another payment method.',
		40001013 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		40001016 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		40001018 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_TRY_AGAIN,
		...
		40001050 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		...
		50001007 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001008 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001009 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001010 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001011 => 'Brand not supported for that merchant.',
		50001012 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001013 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001014 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001015 => 'Invalid currency code.',
		50001016 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001017 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001018 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001019 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001020 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001021 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001022 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001023 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001024 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001025 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001026 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001027 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001028 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001029 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001030 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001031 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001032 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001033 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001034 => self::A_TECHNICAL_HAS_PROBLEM_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001035 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		...
		50001043 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		...
		50001047 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001048 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001049 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001050 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001051 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001052 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001053 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001054 => 'Card number incorrect or incompatible.',
		50001055 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001056 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001057 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001058 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001059 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001060 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001061 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
		50001062 => self::A_TECHNICAL_PROBLEM_HAS_OCCURRED_PLEASE_CONTACT_THE_HELPDESK,
