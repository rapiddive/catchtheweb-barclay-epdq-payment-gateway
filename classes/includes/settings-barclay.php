...
return array(
    ...
    'brand_cards' => array(
        ...
        'class'             => 'wc-enhanced-select',
        'css'               => 'width: 400px;',
        'description' => __('Brand of Cards Selected by the Merchant eg. VISA, MESTRO. If blank all cards accepted', 'woocommerce'),
        'default' => '',
        'desc_tip' => true,
        'options' => array(
        	'' => 'all',
    ...
    'secure_3d' => array(
        ...
        'description' => __('Require Secure 3D Payments Main Windows is default as recommened as many card services donot support them', 'woocommerce'),
        'default' => 'MAINW',
        'desc_tip' => false,
        ),
    'method_list' => array(
    ...
    'com_plus' => array(
        ...
        'type' => 'text',
        'description' => __('Field for submitting a value you would like to be returned in the feedback request.', 'woocommerce'),
    ...
    'param_plus' => array(
        ...
        'type' => 'text',
        'description' => __('Field for submitting some parameters and their values you would like to be returned in the feedback request. The field PARAMPLUS is not included in the feedback parameters as such; instead, the parameters/values you submit in this field will be parsed and the resulting parameters added to the http request.', 'woocommerce'),
