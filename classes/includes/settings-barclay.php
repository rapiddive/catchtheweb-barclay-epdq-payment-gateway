...
return array(
    ...
    'cvccheck' => array(
        ...
        'default' => 'no',
        'description' => 'Result of the card verification code check. Only a few acquirers return specific CVC check results. For most acquirers, the CVC is assumed to be correct if the transaction is successfully authorised.<br>
        Possible values:<br>
    ...
    'description' => array(
        ...
        'type' => 'textarea',
        'description' => __('Description of the payment process. This description will be visible throughout the site and the payment page.',
            'woocommerce'),
    ...
    'access_key' => array(
        ...
        'type' => 'text',
        'description' => __('The PSPID for your barclay account. This is the id which you use to login the admin panel of the barclay bank.',
            'woocommerce'),
        'default' => '',
        'desc_tip' => true
    ),
    'status' => array(
        ...
        'description' => __('The status of your store tells that are you actually ready to run your shop or its still a test environment. If the test is selected then no payments will be processed. For details please refer to the user guide provided by the Barclay EPDQ service.',
            'woocommerce'),
        'default' => '',
        'desc_tip' => true,
    ),
    ...
    'sha_method' => array(
        ...
        'description' => __('SHA encryption method - this needs to match what you have set in the EPDQ backoffice.',
            'woocommerce'),
        'default' => '',
        'desc_tip' => true,
    ),
    ...
    'method_list' => array(
        ...
        'type' => 'multiselect',
        'description' => __('List of CARD services accepted for payments seperated by eg:VISA;iDEA', 'woocommerce'),
        'class' => 'wc-enhanced-select',
        'css' => 'width: 400px;',
        'default' => '',
        'desc_tip' => true,
